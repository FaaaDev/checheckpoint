...
class TenWrapperView extends GetView<TenWrapperController> {
  const TenWrapperView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    Get.put(TenWrapperController());
    return GetBuilder<TenWrapperController>(
      assignId: true,
      builder: (ctrl) {
        return Column(
          children: [
