...
class TenGenderView extends GetView<TenGenderController> {
  const TenGenderView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(TenGenderController());
    return Responsive.isMobile(context)
        ? GetBuilder<TenGenderController>(builder: (ctrl) {
